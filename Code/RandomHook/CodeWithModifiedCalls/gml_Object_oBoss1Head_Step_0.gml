...
if (state == 0)
{
    ...
    if (statetime > 220 && image_index < 5)
        image_index += 0.2
    if (statetime == 280)
    {
        state = 1
...
if (state == 2)
{
    ...
    if (statetime == 5)
    {
        eyes = instance_create(x, (y + 14), oBoss1Eyes)
...
if (state == 100)
{
    ...
    if (statetime == 250)
    {
        repeat (10)
        {
            ...
            expl.direction = 180 + tas_random(180)
            expl.speed = 2 + tas_random(1)
        }
        repeat (10)
            make_explosion3((x + (tas_random_range(-30, 30))), (y + (tas_random_range(-30, 30))))
        repeat (60)
