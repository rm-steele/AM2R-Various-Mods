if (oCharacter.x < 512 && active == 0)
{
    ...
    repeat (8)
    {
        mytrail = instance_create((440 + tas_random(32)), (176 + tas_random(32)), oFXTrail)
        mytrail.sprite_index = sRockPieceA2
        mytrail.image_index = floor(tas_random(6))
        mytrail.image_alpha = 1
        mytrail.fadespeed = 0.005
        mytrail.additive = 0
        mytrail.vspeed = -3 - tas_random(5)
        mytrail.hspeed = -3 + tas_random(4)
        mytrail.gravity = 0.2
