...
if (state == STANDING)
{
    ...
    else
    {
        if (facing == RIGHT)
        {
            ...
            if (set == 1)
                sprite_index = sVStandRight
            if (set == 2)
                sprite_index = sGStandRight
            image_speed = 0.1
            if (idle == timetoidle)
                idleanim = round(tas_random(1))
            if (idle > timetoidle && (!instance_exists(oEMPNoise)))
            {
                ...
                if (set == 1)
                    sprite_index = sVIdleRight
                if (set == 2)
                    sprite_index = sGIdleRight
                if (idleanim == 0)
                {
                    ...
                    {
                        idle = 0
                        timetoidle = 300 + floor(tas_random(300))
                    }
                }
                if (idleanim == 1)
                {
            ...
            {
                if (set == 0)
                    sprite_index = sStandAimUR
                if (set == 1)
                    sprite_index = sVStandAimUR
                if (set == 2)
                    sprite_index = sGStandAimUR
                image_speed = 0.1
            }
            if (aimdirection == 4)
            {
                if (set == 0)
                    sprite_index = sStandAimDR
                if (set == 1)
                    sprite_index = sVStandAimDR
                if (set == 2)
                    sprite_index = sGStandAimDR
                image_speed = 0.1
            }
            if (aimdirection == 6)
            {
                if (set == 0)
                    sprite_index = sStandAimUp
                if (set == 1)
                    sprite_index = sVStandAimUp
                if (set == 2)
                    sprite_index = sGStandAimUp
                image_speed = 0.1
            }
        }
        if (facing == LEFT)
        {
            ...
            if (set == 1)
                sprite_index = sVStandLeft
            if (set == 2)
                sprite_index = sGStandLeft
            image_speed = 0.1
            if (idle == timetoidle)
                idleanim = round(tas_random(1))
            if (idle > timetoidle && (!instance_exists(oEMPNoise)))
            {
                ...
                if (set == 1)
                    sprite_index = sVIdleLeft
                if (set == 2)
                    sprite_index = sGIdleLeft
                if (idleanim == 0)
                {
                    if (idle > timetoidle && idle <= (timetoidle + 10))
                        image_index = 0
            ...
            {
                if (set == 0)
                    sprite_index = sStandAimUL
                if (set == 1)
                    sprite_index = sVStandAimUL
                if (set == 2)
                    sprite_index = sGStandAimUL
                image_speed = 0.1
            }
            if (aimdirection == 5)
            {
                if (set == 0)
                    sprite_index = sStandAimDL
                if (set == 1)
                    sprite_index = sVStandAimDL
                if (set == 2)
                    sprite_index = sGStandAimDL
                image_speed = 0.1
            }
            if (aimdirection == 6)
            {
                if (set == 0)
                    sprite_index = sStandAimUpL
                if (set == 1)
                    sprite_index = sVStandAimUpL
                if (set == 2)
                    sprite_index = sGStandAimUpL
                image_speed = 0.1
            }
        }
    }
    ...
    else
    {
        if (facing == RIGHT && walking == 0)
        {
            if (aimdirection == 0 && firing == 0 && armmsl == 0)
            {
                ...
                if (set == 1)
                    sprite_index = sVRunRight
                if (set == 2)
                    sprite_index = sGRunRight
                image_speed = 0.5
            }
            if (aimdirection == 0 && (firing > 0 || armmsl == 1))
            {
                if (set == 0)
                    sprite_index = sRunAimR
                if (set == 1)
                    sprite_index = sVRunAimR
                if (set == 2)
                    sprite_index = sGRunAimR
                image_speed = 0.5
            }
            if (aimdirection == 2)
            {
                if (set == 0)
                    sprite_index = sRunAimUR
                if (set == 1)
                    sprite_index = sVRunAimUR
                if (set == 2)
                    sprite_index = sGRunAimUR
                image_speed = 0.5
            }
            if (aimdirection == 4)
            {
                if (set == 0)
                    sprite_index = sRunAimDR
                if (set == 1)
                    sprite_index = sVRunAimDR
                if (set == 2)
                    sprite_index = sGRunAimDR
                image_speed = 0.5
            }
        }
        if (facing == LEFT && walking == 0)
        {
            if (aimdirection == 1 && firing == 0 && armmsl == 0)
            {
                ...
                if (set == 1)
                    sprite_index = sVRunLeft
                if (set == 2)
                    sprite_index = sGRunLeft
                image_speed = 0.5
            }
            if (aimdirection == 1 && (firing > 0 || armmsl == 1))
            {
                if (set == 0)
                    sprite_index = sRunAimL
                if (set == 1)
                    sprite_index = sVRunAimL
                if (set == 2)
                    sprite_index = sGRunAimL
                image_speed = 0.5
            }
            if (aimdirection == 3)
            {
                if (set == 0)
                    sprite_index = sRunAimUL
                if (set == 1)
                    sprite_index = sVRunAimUL
                if (set == 2)
                    sprite_index = sGRunAimUL
                image_speed = 0.5
            }
            if (aimdirection == 5)
            {
                if (set == 0)
                    sprite_index = sRunAimDL
                if (set == 1)
                    sprite_index = sVRunAimDL
                if (set == 2)
                    sprite_index = sGRunAimDL
                image_speed = 0.5
            }
        }
        if (facing == RIGHT && walking == 1)
        {
            if (aimdirection == 0 && firing == 0 && armmsl == 0 && aimlock == 0)
            {
                ...
                if (set == 1)
                    sprite_index = sVWalkRight
                if (set == 2)
                    sprite_index = sGWalkRight
            }
            if (aimdirection == 0 && (firing > 0 || armmsl == 1 || aimlock == 1))
            {
                if (set == 0)
                    sprite_index = sWalkAimR
                if (set == 1)
                    sprite_index = sVWalkAimR
                if (set == 2)
                    sprite_index = sGWalkAimR
            }
            if (aimdirection == 2)
            {
                if (set == 0)
                    sprite_index = sWalkAimUR
                if (set == 1)
                    sprite_index = sVWalkAimUR
                if (set == 2)
                    sprite_index = sGWalkAimUR
            }
            if (aimdirection == 4)
            {
                if (set == 0)
                    sprite_index = sWalkAimDR
                if (set == 1)
                    sprite_index = sVWalkAimDR
                if (set == 2)
                    sprite_index = sGWalkAimDR
            }
            if (aimdirection == 6)
            {
                if (set == 0)
                    sprite_index = sWalkAimUp
                if (set == 1)
                    sprite_index = sVWalkAimUp
                if (set == 2)
                    sprite_index = sGWalkAimUp
            }
            if (xVel > 0)
                image_speed = 0.25
            else if (xVel < 0)
        ...
        if (facing == LEFT && walking == 1)
        {
            if (aimdirection == 1 && firing == 0 && armmsl == 0 && aimlock == 0)
            {
                ...
                if (set == 1)
                    sprite_index = sVWalkLeft
                if (set == 2)
                    sprite_index = sGWalkLeft
            }
            if (aimdirection == 1 && (firing > 0 || armmsl == 1 || aimlock == 1))
            {
                if (set == 0)
                    sprite_index = sWalkAimL
                if (set == 1)
                    sprite_index = sVWalkAimL
                if (set == 2)
                    sprite_index = sGWalkAimL
            }
            if (aimdirection == 3)
            {
                if (set == 0)
                    sprite_index = sWalkAimUL
                if (set == 1)
                    sprite_index = sVWalkAimUL
                if (set == 2)
                    sprite_index = sGWalkAimUL
            }
            if (aimdirection == 5)
            {
                if (set == 0)
                    sprite_index = sWalkAimDL
                if (set == 1)
                    sprite_index = sVWalkAimDL
                if (set == 2)
                    sprite_index = sGWalkAimDL
            }
            if (aimdirection == 6)
            {
                if (set == 0)
                    sprite_index = sWalkAimUpL
                if (set == 1)
                    sprite_index = sVWalkAimUpL
                if (set == 2)
                    sprite_index = sGWalkAimUpL
            }
            if (xVel < 0)
                image_speed = 0.25
            else if (xVel > 0)
...
if (state == DUCKING)
{
    ...
    {
        if (set == 0)
            sprite_index = sUnmorph
        if (set == 1)
            sprite_index = sVUnmorph
        if (set == 2)
            sprite_index = sGUnmorph
        image_speed = 0.8
    }
    else if (turning == 1)
    {
        if (set == 0)
            sprite_index = sCrouchTurn
        if (set == 1)
            sprite_index = sVCrouchTurn
        if (set == 2)
            sprite_index = sGCrouchTurn
        image_speed = 0.5
    }
    else
    {
        ...
        if (set == 1)
            sprite_index = sVCrouch
        if (set == 2)
            sprite_index = sGCrouch
        image_speed = 0.1
    }
}
if (state == JUMPING)
{
    if (vjump == 0)
    {
        if (facing == RIGHT)
        {
            ...
            if (set == 1)
                sprite_index = sVJumpRight
            if (set == 2)
                sprite_index = sGJumpRight
            image_speed = 0.75
        }
        if (facing == LEFT)
        {
            ...
            if (set == 1)
                sprite_index = sVJumpLeft
            if (set == 2)
                sprite_index = sGJumpLeft
            image_speed = 0.75
        }
        if (global.spacejump == 1 && statetime > 4 && (inwater == 0 || global.currentsuit == 2))
        {
            if (set == 0)
                sprite_index = sSpacejump
            if (set == 1)
                sprite_index = sVSpacejump
            if (set == 2)
                sprite_index = sGSpacejump
            image_speed = 1
        }
    }
    if (vjump == 1)
    {
        ...
        {
            if (set == 0)
                sprite_index = sAirTurn
            if (set == 1)
                sprite_index = sVAirTurn
            if (set == 2)
                sprite_index = sGAirTurn
            image_speed = 0.5
            if (aimdirection == 7)
            {
                if (facing == RIGHT)
                {
                    if (set == 0)
                        sprite_index = sJAimDwnTR
                    if (set == 1)
                        sprite_index = sVJAimDwnTR
                    if (set == 2)
                        sprite_index = sGJAimDwnTR
                    image_speed = 0.75
                }
                if (facing == LEFT)
                {
                    if (set == 0)
                        sprite_index = sJAimDwnTL
                    if (set == 1)
                        sprite_index = sVJAimDwnTL
                    if (set == 2)
                        sprite_index = sGJAimDwnTL
                    image_speed = 0.75
                }
            }
        }
        ...
        else
        {
            if (aimdirection != 7)
            {
                if (set == 0)
                    sprite_index = sVjump
                if (set == 1)
                    sprite_index = sVVjump
                if (set == 2)
                    sprite_index = sGVjump
                image_speed = 0.2
            }
            if (aimdirection == 7)
            {
                ...
                {
                    if (set == 0)
                        sprite_index = sJAimDwnR
                    if (set == 1)
                        sprite_index = sVJAimDwnR
                    if (set == 2)
                        sprite_index = sGJAimDwnR
                    image_speed = 0.75
                }
                if (facing == LEFT)
                {
                    if (set == 0)
                        sprite_index = sJAimDwnL
                    if (set == 1)
                        sprite_index = sVJAimDwnL
                    if (set == 2)
                        sprite_index = sGJAimDwnL
                    image_speed = 0.75
                }
            }
        }
    ...
    if (walljumping == 1)
    {
        ...
        {
            if (set == 0)
                sprite_index = sWalljump
            if (set == 1)
                sprite_index = sVWalljump
            if (set == 2)
                sprite_index = sGWalljump
            image_speed = 1
        }
        if (facing == LEFT)
        {
            if (set == 0)
                sprite_index = sWalljumpL
            if (set == 1)
                sprite_index = sVWalljumpL
            if (set == 2)
                sprite_index = sGWalljumpL
            image_speed = 1
        }
    }
}
...
if (state == BALL)
{
    if (morphing == 1)
    {
        if (set == 0)
            sprite_index = sMorph
        if (set == 1)
            sprite_index = sVMorph
        if (set == 2)
            sprite_index = sGMorph
    ...
    {
        if (set == 0)
            sprite_index = sMorphBallTurn
        if (set == 1)
            sprite_index = sVMorphBallTurn
        if (set == 2)
            sprite_index = sGMorphBallTurn
        image_speed = 1
    }
    else
    {
        if (set == 0)
            sprite_index = sMorphBall
        if (set == 1)
            sprite_index = sVMorphBall
        if (set == 2)
            sprite_index = sGMorphBall
        image_speed = 0.3
    }
}
if (state == AIRBALL || state == GRABBEDQUEENMORPH || state == GRABBEDQUEENBELLY)
{
    ...
    {
        if (set == 0)
            sprite_index = sAirMorphBall
        if (set == 1)
            sprite_index = sVAirMorphBall
        if (set == 2)
            sprite_index = sGAirMorphBall
        image_speed = 0.3
    }
}
...
{
    if (set == 0)
        sprite_index = sBittenL
    if (set == 1)
        sprite_index = sVBittenL
    if (set == 2)
        sprite_index = sGBittenL
}
if (state == SPIDERBALL || (state == AIRBALL && sball == 1))
{
    if (set == 0)
        sprite_index = sSpiderMorphBall
    if (set == 1)
        sprite_index = sVSpiderMorphBall
    if (set == 2)
        sprite_index = sGSpiderMorphBall
    image_speed = 0.3
}
if (state == LOCKEDBALL)
{
...
if (state == GRIP)
{
    if (facing == RIGHT)
    {
        ...
        {
            if (set == 0)
                sprite_index = sGripTurnR
            if (set == 1)
                sprite_index = sVGripTurnR
            if (set == 2)
                sprite_index = sGGripTurnR
            image_speed = 0.5
        }
        else
        {
            ...
            {
                if (set == 0)
                    sprite_index = sGripAimL
                if (set == 1)
                    sprite_index = sVGripAimL
                if (set == 2)
                    sprite_index = sGGripAimL
                image_speed = 0.1
            }
            if (aimdirection == 3)
            {
                if (set == 0)
                    sprite_index = sGripAimUL
                if (set == 1)
                    sprite_index = sVGripAimUL
                if (set == 2)
                    sprite_index = sGGripAimUL
                image_speed = 0.1
            }
            if (aimdirection == 5)
            {
                if (set == 0)
                    sprite_index = sGripAimDL
                if (set == 1)
                    sprite_index = sVGripAimDL
                if (set == 2)
                    sprite_index = sGGripAimDL
                image_speed = 0.1
            }
            if (aimdirection == 6)
            {
                if (set == 0)
                    sprite_index = sGripAimUpR
                if (set == 1)
                    sprite_index = sVGripAimUpR
                if (set == 2)
                    sprite_index = sGGripAimUpR
                image_speed = 0.1
            }
            if (aimdirection == 7)
            {
                if (set == 0)
                    sprite_index = sGripAimDwnR
                if (set == 1)
                    sprite_index = sVGripAimDwnR
                if (set == 2)
                    sprite_index = sGGripAimDwnR
                image_speed = 0.1
            }
        }
    }
    if (facing == LEFT)
    {
        ...
        {
            if (set == 0)
                sprite_index = sGripTurnL
            if (set == 1)
                sprite_index = sVGripTurnL
            if (set == 2)
                sprite_index = sGGripTurnL
            image_speed = 0.5
        }
        else
        {
            if (aimdirection == 1 || aimdirection == 3 || aimdirection == 5)
            {
                if (set == 0)
                    sprite_index = sGripL
                if (set == 1)
                    sprite_index = sVGripL
                if (set == 2)
                    sprite_index = sGGripL
                image_speed = 0.1
            }
            if (aimdirection == 0)
            {
                if (set == 0)
                    sprite_index = sGripAimR
                if (set == 1)
                    sprite_index = sVGripAimR
                if (set == 2)
                    sprite_index = sGGripAimR
                image_speed = 0.1
            }
            if (aimdirection == 2)
            {
                if (set == 0)
                    sprite_index = sGripAimUR
                if (set == 1)
                    sprite_index = sVGripAimUR
                if (set == 2)
                    sprite_index = sGGripAimUR
                image_speed = 0.1
            }
            if (aimdirection == 4)
            {
                if (set == 0)
                    sprite_index = sGripAimDR
                if (set == 1)
                    sprite_index = sVGripAimDR
                if (set == 2)
                    sprite_index = sGGripAimDR
                image_speed = 0.1
            }
            if (aimdirection == 6)
            {
                if (set == 0)
                    sprite_index = sGripAimUpL
                if (set == 1)
                    sprite_index = sVGripAimUpL
                if (set == 2)
                    sprite_index = sGGripAimUpL
                image_speed = 0.1
            }
            if (aimdirection == 7)
            {
                if (set == 0)
                    sprite_index = sGripAimDwnL
                if (set == 1)
                    sprite_index = sVGripAimDwnL
                if (set == 2)
                    sprite_index = sGGripAimDwnL
                image_speed = 0.1
            }
        }
    }
...
if (state == CLIMBING)
{
    if (facing == RIGHT)
    {
        if (set == 0)
            sprite_index = sClimb
        if (set == 1)
            sprite_index = sVClimb
        if (set == 2)
            sprite_index = sGClimb
        image_speed = 1
    }
    if (facing == LEFT)
    {
        if (set == 0)
            sprite_index = sClimbL
        if (set == 1)
            sprite_index = sVClimbL
        if (set == 2)
            sprite_index = sGClimbL
        image_speed = 1
    }
}
if (state == BRAKING)
{
    if (sjball == 0)
    {
        ...
        {
            if (set == 0)
                sprite_index = sBrakeR
            if (set == 1)
                sprite_index = sVBrakeR
            if (set == 2)
                sprite_index = sGBrakeR
            image_speed = 0.2
        }
        if (facing == LEFT)
        {
            if (set == 0)
                sprite_index = sBrakeL
            if (set == 1)
                sprite_index = sVBrakeL
            if (set == 2)
                sprite_index = sGBrakeL
            image_speed = 0.2
        }
    }
    if (sjball == 1)
...
if (state == SJSTART && sjball == 0)
{
    if (facing == RIGHT)
    {
        ...
        if (set == 1)
            sprite_index = sVSJumpStart
        if (set == 2)
            sprite_index = sGSJumpStart
        image_speed = 0.3
    }
    if (facing == LEFT)
    {
        if (set == 0)
            sprite_index = sSJumpStartL
        if (set == 1)
            sprite_index = sVSJumpStartL
        if (set == 2)
            sprite_index = sGSJumpStartL
        image_speed = 0.3
    }
}
if (state == SUPERJUMP && sjball == 0)
{
    if (sjdir == 0)
    {
        ...
        {
            if (set == 0)
                sprite_index = sSJumpUpR
            if (set == 1)
                sprite_index = sVSJumpUpR
            if (set == 2)
                sprite_index = sGSJumpUpR
            image_speed = 0.5
        }
        if (facing == LEFT)
        {
            if (set == 0)
                sprite_index = sSJumpUpL
            if (set == 1)
                sprite_index = sVSJumpUpL
            if (set == 2)
                sprite_index = sGSJumpUpL
            image_speed = 0.5
        }
    }
    else
    {
        ...
        {
            if (set == 0)
                sprite_index = sSJumpR
            if (set == 1)
                sprite_index = sVSJumpR
            if (set == 2)
                sprite_index = sGSJumpR
            image_speed = 0.4
        }
        if (facing == LEFT)
        {
            if (set == 0)
                sprite_index = sSJumpL
            if (set == 1)
                sprite_index = sVSJumpL
            if (set == 2)
                sprite_index = sGSJumpL
            image_speed = 0.4
        }
    }
}
    ...
    if (sjball == 0)
    {
        if (facing == RIGHT)
        {
            if (set == 0)
                sprite_index = sHurtR
            if (set == 1)
                sprite_index = sVHurtR
            if (set == 2)
                sprite_index = sGHurtR
            image_speed = 0.2
        }
        if (facing == LEFT)
        {
            if (set == 0)
                sprite_index = sHurtL
            if (set == 1)
                sprite_index = sVHurtL
            if (set == 2)
                sprite_index = sGHurtL
            image_speed = 0.2
        }
    }
    if (sjball == 1)
...
if (state == IDLE || state == SAVING || state == SAVINGSHIP || state == ELEVATOR || state == GFELEVATOR)
{
    if (facing == 0)
    {
        if (set == 0)
            sprite_index = sFront
        if (set == 1)
            sprite_index = sVFront
        if (set == 2)
            sprite_index = sGFront
        image_speed = 0.1
    }
    if (facing == RIGHT)
    {
        ...
        if (set == 1)
            sprite_index = sVFrontR
        if (set == 2)
            sprite_index = sGFrontR
        image_speed = 0.5
        aimdirection = 0
    }
    if (facing == LEFT)
    {
        ...
        if (set == 1)
            sprite_index = sVFrontL
        if (set == 2)
            sprite_index = sGFrontL
        image_speed = 0.5
        aimdirection = 1
    }
}
...
if (state == KNOCKBACK1 || state == KNOCKBACK2)
{
    ...
    {
        if (set == 0)
            sprite_index = sKnockbackR
        if (set == 1)
            sprite_index = sVKnockbackR
        if (set == 2)
            sprite_index = sGKnockbackR
    }
    if (facing == LEFT)
    {
        if (set == 0)
            sprite_index = sKnockbackL
        if (set == 1)
            sprite_index = sVKnockbackL
        if (set == 2)
            sprite_index = sGKnockbackL
    }
}
if (state == KNOCKBACK1_LAND || state == KNOCKBACK2_LAND)
{
    ...
    {
        if (set == 0)
            sprite_index = sKnockLandR
        if (set == 1)
            sprite_index = sVKnockLandR
        if (set == 2)
            sprite_index = sGKnockLandR
    }
    if (facing == LEFT)
    {
        if (set == 0)
            sprite_index = sKnockLandL
        if (set == 1)
            sprite_index = sVKnockLandL
        if (set == 2)
            sprite_index = sGKnockLandL
    }
}
if (state == A4EXPL)
{
...
if ((inwater == 1 && global.currentsuit != 2) || metroid_drain > 0)
{
...
if (global.screwattack == 1 && state == JUMPING && vjump == 0 && walljumping == 0 && (inwater == 0 || global.currentsuit >= 2))
{
    ...
    mytrail.image_index = round(tas_random(2))
    mytrail.image_alpha = 1 + fxtimer * 0.1
    mytrail.image_blend = make_color_rgb((50 + tas_random(200)), 255, (50 + tas_random(200)))
    if (tas_random(10) < 1)
...
if (state == RUNNING && speedboost && (fxtimer == 0 || fxtimer == 2 || fxtimer == 4))
    myspark = instance_create(x, (y - tas_random(36)), oSBSpark)
if (onfire && fxtimer == 0)
{
    if (mask_index == sMask1)
        expl = instance_create((x + (tas_random_range(-8, 8))), (y - tas_random(28)), oFXAnimSpark)
    else
        expl = instance_create((x + (tas_random_range(-8, 8))), (y - tas_random(16)), oFXAnimSpark)
