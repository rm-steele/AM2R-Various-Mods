...
if (shaking > 0)
{
    xoff0 = tas_choose(-1, 0, 1)
    yoff0 = tas_choose(-1, 0, 1)
    xoff1 = tas_choose(-1, 0, 1)
    yoff1 = tas_choose(-1, 0, 1)
    xoff2 = tas_choose(-1, 0, 1)
    yoff2 = tas_choose(-1, 0, 1)
    xoff3 = tas_choose(-1, 0, 1)
    yoff3 = tas_choose(-1, 0, 1)
    xoff4 = tas_choose(-1, 0, 1)
    yoff4 = tas_choose(-1, 0, 1)
}
else
{
    xoff0 = 0
