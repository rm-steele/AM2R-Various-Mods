...
if surface_exists(surf)
{
    ...
    if (bleg_shake > 0)
    {
        bl_xoff = tas_choose(-1, 0, 1)
        bl_yoff = tas_choose(-1, 0, 1)
    }
    if (barm_shake > 0)
    {
        ba_xoff = tas_choose(-1, 0, 1)
        ba_yoff = tas_choose(-1, 0, 1)
    }
    if (body_shake > 0)
    {
        bo_xoff = tas_choose(-1, 0, 1)
        bo_yoff = tas_choose(-1, 0, 1)
    }
    if (head_shake > 0)
    {
        he_xoff = tas_choose(-1, 0, 1)
        he_yoff = tas_choose(-1, 0, 1)
    }
    if (farm_shake > 0)
    {
        fa_xoff = tas_choose(-1, 0, 1)
        fa_yoff = tas_choose(-1, 0, 1)
    }
    if (fleg_shake > 0)
    {
        fl_xoff = tas_choose(-1, 0, 1)
        fl_yoff = tas_choose(-1, 0, 1)
    }
    if (bleg_spr != -4)
